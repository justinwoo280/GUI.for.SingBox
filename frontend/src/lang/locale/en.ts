  ...
  kernel: {
    ...
    outbounds: {
      ...
      ewpFields: {
        ...
        tls_server_name: 'SNI (server_name)',
        tls_insecure: 'Allow Insecure',
        tls_alpn: 'ALPN (comma-separated)',
        tls_fingerprint: 'uTLS Fingerprint',
        ech: 'ECH',
        ech_enabled: 'Enable ECH',
        ech_config: 'ECH Config (PEM, leave empty to fetch via DNS)',
        ech_query_server_name: 'ECH Query Server Name (default: SNI)',
        reality: 'Reality',
        ...
        ws_headers: 'WebSocket Headers (JSON)',
        grpc_service_name: 'gRPC service_name',
        http_host: 'HTTP host (comma-separated)',
        http_path: 'HTTP path',
        ech_reality_mutex: 'ECH and Reality are mutually exclusive; only one may be enabled.',
      },
    },
    route: {
      tab: {
