  ...
  kernel: {
    ...
    outbounds: {
      ...
      ewpFields: {
        ...
        tls_insecure: '允许不安全证书',
        tls_alpn: 'ALPN (英文逗号分隔)',
        tls_fingerprint: 'uTLS 指纹',
        ech: 'ECH',
        ech_enabled: '启用 ECH',
        ech_config: 'ECH 配置 (PEM, 留空则自动从 DNS 拉取)',
        ech_query_server_name: 'ECH 查询域名 (留空则同 SNI)',
        reality: 'Reality',
        reality_enabled: '启用 Reality',
        reality_public_key: 'Reality public_key',
        reality_short_id: 'Reality short_id',
        transport: '传输',
        transport_type: '传输类型',
        ws_path: 'WebSocket 路径',
        ws_headers: 'WebSocket 头部 (JSON)',
        grpc_service_name: 'gRPC service_name',
        http_host: 'HTTP host (英文逗号分隔)',
        http_path: 'HTTP path',
        ech_reality_mutex: 'ECH 与 Reality 互斥, 只能启用其一',
      },
    },
    route: {
      tab: {
